# u1-force-macros: instructions for AI assistants
...
This repo is a co-repo of Bespok3d plugins for the Snapmaker U1 that publishes its own sub-list. It
ships four plugins, each config, patches, assets, and shell only, no Python:
