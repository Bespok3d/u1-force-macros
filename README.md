...
each `.b3`, cuts a release per plugin, assembles this repo's `index.json` sub-list as `U1 Force
Macros`, and registers it in `Bespok3d/main-index` (`lists/<repo>.json`). Secrets:
